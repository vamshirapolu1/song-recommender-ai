...
# Mood detection dictionary - ALL 12 MOODS FULLY RESTORED
mood_keywords = {
...
def detect_mood(user_input):
    ...
    # Flip logic if negation is found (e.g., "not happy" -> Sad)
    if is_negated:
...
def home():
    ...
    if request.method == "POST":
        ...
        if not filtered.empty:
            ...
            # Thumbnails for upgraded interface
